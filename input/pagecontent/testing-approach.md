...
<table border="1" cellspacing="0" cellpadding="0" width="100%">
    ...
    <tbody>
        ...
        <td rowspan="6">Derives from profile C with no additional constraints on whenPrepared, to test inheritance through a second level of derivation</td>
        <td>whenPrepared not present, no DAR</td>
        <td>Fail - inherited mandatory requirement (neither value nor DAR present)</td>
        <td><a href="MedicationDispense-medicationdispense-wp-f-01.html">medicationdispense-wp-f-01</a></td>
        </tr>
        <tr>
            <td>whenPrepared present, full datetime</td><td>Pass</td><td><a href="MedicationDispense-medicationdispense-wp-f-02.html">medicationdispense-wp-f-02</a></td></tr>
        <tr>
